    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-hidden flex">
          {/* Sidebar */}
          <div className="w-1/3 border-r border-gray-100 bg-gray-50/30 flex flex-col h-full overflow-hidden">
            {loading ? (
                ...
                <div className="p-4 border-b border-gray-100">
                  <button 
                    onClick={() => {
                        ...
                        setTemplates({...templates, [newKey]: { title: 'Novo Formulário', questions: [] }});
                        setSelectedType(newKey);
                        setEditingTitle('Novo Formulário');
                        setEditingQuestions([]);
                    }}
                    className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-brand-dark text-white rounded-xl text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-all shadow-sm"
                  >
